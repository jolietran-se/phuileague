...
@section('content')
    ...
    <input type="hidden" id="ownerID" value="{{ $club->owner_id }}">
    <!-- Header TabList -->
            ...
            <div class="col-md-3">
                <div id="tablist-setting">
                    <ul class="nav nav-pills nav-stacked">
                        ...
                        @endif
                        <li role="presentation" class="active"><a href="{{ route('club.member', $club->slug)}}">Thành viên <small>({{ isset($club->number_player)?$club->number_player:0 }})</small><span class="glyphicon glyphicon-chevron-right"></a></li>
                ...
                <div class="panel panel-success">
                    ...
                    <div id="add-member">
                        <div class="page-header text-center">
                            <h6><strong>Thêm thành viên</strong></h6>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            ...
                                            <form class="form-horizontal" role="form" method="post" id="edit-member">
                                                {{ csrf_field() }}
                                ...
                                <div class="col-md-3" id="demo-avatar">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption text-center">
                                            <div class="player-name"><small><b>{{ $player->name }}</b></small><br></div>
                                            ...
                                            <small>
                                                <a href="#" class="btn btn-default edit-player" role="button" id="detail-player1"
                                                    data-id="{{ $player->id }}"
                                                ...
                                                <a href="#" class="btn btn-danger delete-player" role="button" id="delete-player1"
                                                    data-id="{{ $player->id }}">
                                                    <small>Xóa</small>
                                                </a>
                                            </small>
                            ...
                            @foreach ($player2s as $player)
                                <div class="col-md-3" id="demo-avatar">
                                    <div class="thumbnail">
                                        ...
                                        @endif
                                        <div class="caption text-center">
                                            <div class="player-name"><small><b>{{ $player->name }}</b></small></div>
                                            <small>Số áo: {{ $player->uniform_number }}</small><br>
                                            <small>Vị trí: 
                                                @switch($player->position)
                                                    @case(1)
                                            ...
                                            <small>{{ $player->ismain==1?"Đội hình thi đấu":"Đội hình dự bị" }}</small><br>
                                            <small>
                                                <a href="#" class="btn btn-default edit-player" role="button" id="detail-player2"
                                                    data-id="{{ $player->id }}"
                                                    data-name = "{{ $player->name }}"
                                                    data-avatar = "{{ $player->avatar }}"
                                                    data-uniform-number = "{{ $player->uniform_number }}"
                                                    ...
                                                    data-ismain = "{{ $player->ismain }}"
                                                ><small>Chi tiết</small></a>
                                                <a href="#" class="btn btn-danger delete-player" role="button" id="delete-player2"
                                                    data-id="{{ $player->id }}"
                                                ><small>Xóa</small></a>
                                            </small>
                                        </div>
...
@section('foot')
    ...
    <script type="text/javascript">
        ...
        if(userID != ownerID){
            $('#add-member').hide();
            $('#modals').hide();
            $('#edit-member input').attr('readonly', 'readonly');
            $('#edit-member select').attr('readonly', 'readonly');
            $('#detail-member button').hide();
            $('#list-member a#delete-player1').hide();
            $('#list-member a#delete-player2').hide();
            $('.btn.edit-player').css('width','100%');
        }
    </script>
